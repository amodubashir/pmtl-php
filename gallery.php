...
<body>
    <div class="boxed_wrapper">
        ...
        <section class="breadcrumb-area style2" style="background-image: url(images/resources/banner1.png);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content-box clearfix">
                            <div class="title-s2 text-center">
                                ...
                                <h2 style="color: white;">Sight from PMTL</h2>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row filter-layout masonary-layout">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item contem ret">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/gallery/factory-1.png" alt="Awesome Image">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod trad">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/gallery/factory-2.png" alt="Awesome Image">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod contem">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/gallery/factory-3.png" alt="Awesome Image">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod trad">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/gallery/factory-4.png" alt="Awesome Image">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod contem">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/gallery/factory-5.png" alt="Awesome Image">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod contem ">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/gallery/factory-6.png" alt="Awesome Image">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod contem">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/gallery/factory-7.png" alt="Awesome Image">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item contem ret">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/gallery/factory-8.png" alt="Awesome Image">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod trad">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/gallery/factory-9.png" alt="Awesome Image">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <li><a href="gallery.php"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
                            <li class="active"><a href="gallery">1</a></li>
                            <li><a href="gallery2.php">2</a></li>
                            <li><a href="gallery2.php"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
